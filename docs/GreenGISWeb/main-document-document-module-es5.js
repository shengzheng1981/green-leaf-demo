(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main-document-document-module"], {
    ...
    /***/
    function A4Yb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_document_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./document.component.html */
      "mVIq");
      /* harmony import */


      var _document_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var DocumentComponent = /*#__PURE__*/function () {
        function DocumentComponent(configService, router, http) {
        ...
        _createClass(DocumentComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.http.get("assets/json/docs.json").subscribe(function (data) {
              return _this.docs = data;
            });
          }
        }, {
          key: "change",
          value: function change(doc) {
            var _this2 = this;

            this.article = doc;
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpHeaders"]().set('Content-Type', 'text/plain; charset=utf-8');
            this.http.get("assets/docs/" + doc.article, {
              headers: headers,
              responseType: 'text'
            }).subscribe(function (data) {
              _this2.markdown.nativeElement.innerHTML = marked(data);
            });
          }
        }]);
      ...
      DocumentComponent.ctorParameters = function () {
        return [{
      ...
      DocumentComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function IGj2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function LMyN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DocumentModule", function () {
      ...
      var DocumentModule = function DocumentModule() {
        _classCallCheck(this, DocumentModule);
      };

      DocumentModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_document_component__WEBPACK_IMPORTED_MODULE_5__["DocumentComponent"]]
      })], DocumentModule);
      /***/
    },
    ...
    /***/
    function mVIq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
